...
Sighting.create(location: 'Boggs', typez:"bird", singing: "1", aggressive: "0", flying: "1", other: "0", notes: "", user_id: u1.id)
Sighting.create(location: 'Stern', typez:"bird", singing: "1", aggressive: "1", flying: "0", other: "1", notes: "2 birds", user_id: u1.id)
...
Sighting.create(location: 'JBJ', typez:"bird", singing: "0", aggressive: "1", flying: "1", other: "1", notes: "",  user_id: u2.id)
Sighting.create(location: 'LBC', typez:"Nest", singing: "1", aggressive: "0", flying: "0", other: "0", notes: "Nest with eggs", user_id: u2.id)
